...
go build -ldflags "-X gitlab.com/flarenetwork/coreth/plugin/evm.GitCommit=$coreth_commit -X gitlab.com/flarenetwork/coreth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
